...
public class TileGearMachine extends TileMachine {

	public TileGearMachine() {
		super("OxidationChamber", Recipe.GearMachine);
	}
	...
	public void updateEntity() {
		...
		ItemStack recipeOutputStack = RecipeHelper.getRecipeOutput(Recipe.GearMachine, new ItemStack[] { getStackInSlot(0), getStackInSlot(1), getStackInSlot(2) });
		if (recipeOutputStack == null) {
			currentWorkTime = 0;
			return;
		}

		if (RecipeHelper.getValidRecipe(Recipe.GearMachine, new ItemStack[] { getStackInSlot(0), getStackInSlot(1), getStackInSlot(2) }) != null) {
			...
			if (currentWorkTime == MAX_WORK_TICKS) {
				...
				Recipe recipe = RecipeHelper.getValidRecipe(Recipe.GearMachine, new ItemStack[] { getStackInSlot(0), getStackInSlot(1), getStackInSlot(2) });
