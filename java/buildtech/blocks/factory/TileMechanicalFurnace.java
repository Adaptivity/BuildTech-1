...
public class TileMechanicalFurnace extends TileMachine 
{
	...
	{
		super("mechanicalFurnace", Recipe.mecahnicalFurnace);
	}
	...
	public void updateEntity() 
	{
		...
		ItemStack recipeOutputStack = RecipeHelper.getRecipeOutput(Recipe.mecahnicalFurnace, new ItemStack[] { getStackInSlot(0) });
		...
		if (RecipeHelper.getValidRecipe(Recipe.mecahnicalFurnace, new ItemStack[] { getStackInSlot(0) }) != null) {
			...
			if (currentWorkTime == MAX_WORK_TICKS) 
			{
				...
				Recipe recipe = RecipeHelper.getValidRecipe(Recipe.mecahnicalFurnace, new ItemStack[] { getStackInSlot(0) });
