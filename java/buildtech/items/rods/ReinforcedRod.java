...
public class ReinforcedRod extends ItemRods
{

	public ReinforcedRod(int n,Item item) 
	{
		super(n, item);
	}
	...
	{
			list.add("Tier 2 of 4");
		
		}
	@Override
	@SideOnly(Side.CLIENT)
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(Book.MODID + ":" + "reinforcedRod");
	}
}
