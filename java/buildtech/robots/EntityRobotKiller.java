...
import buildtech.Props;

public class EntityRobotKiller extends EntityRobot implements IInventory {

	private static ResourceLocation texture = new ResourceLocation("buildtech", Props.TEXTURE_PATH_ENTITIES + "/robot_killer.png");
	...
	public EntityRobotKiller(World par1World) {
		super(par1World);
	}
