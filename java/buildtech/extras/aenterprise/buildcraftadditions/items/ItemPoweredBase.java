 ...
 * if you would like to view this file in it's original copy, it is located in AEnterprise's GitHub
 * UniversalRed
 *
 */
...
import buildtech.extras.aenterprise.buildcraftadditions.utils.*;
import buildtech.extras.aenterprise.buildcraftadditions.items.*;
...
public class ItemPoweredBase extends Item 
{
	...
	{
		decreaseEnergy(stack, (block.getBlockHardness(world, x, y, z) * (ConfigHandler.powerDifficultyModifiers[world.difficultySetting.getDifficultyId()]) * ConfigHandler.basePowerModifier), player);
		return true;
	}
