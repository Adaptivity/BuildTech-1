...
public class BlockChromaTank extends BlockContainer {

	private IIcon textureStackedSide;
	private IIcon textureBottomSide;
	private IIcon textureTop;

	public BlockChromaTank() {
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer entityplayer, int par6, float par7, float par8, float par9) {
		...
		if (current != null) {
			...
			if (tile instanceof TileChromaTank) {
				TileChromaTank tank = (TileChromaTank) tile;
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		textureStackedSide = par1IconRegister.registerIcon("buildtech:chromatankside");
		textureBottomSide = par1IconRegister.registerIcon("buildtech:chromatankbottomside");
		textureTop = par1IconRegister.registerIcon("buildtech:chromatanktop");
	}
