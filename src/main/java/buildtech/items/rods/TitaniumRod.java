...
public class TitaniumRod extends ItemRods
{
	public TitaniumRod(int n,Item item) {
		super(n, item);
	}
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(Book.MODID + ":" + "titaniumRod");
	}
}