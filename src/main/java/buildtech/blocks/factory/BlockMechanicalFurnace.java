...
public class BlockMechanicalFurnace extends BlockContainer
{
	...
	public BlockMechanicalFurnace(int x,Block block) 
	{
		super(Material.iron);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) 
	{
		...
		if (!world.isRemote) FMLNetworkHandler.openGui(player, ModBuildTech.instance, Book.guiMechanicalFurnace, world, x, y, z);
	...
	{
		textureFront = par1IconRegister.registerIcon("buildtech:mechanicalFurnace");
