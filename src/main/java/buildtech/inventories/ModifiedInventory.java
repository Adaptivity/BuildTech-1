...
public class ModifiedInventory implements IInventory {
    ...
    public ModifiedInventory(String name, int slots, int stackLimit, TileEntity entity){
        this.name = name;
